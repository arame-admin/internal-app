...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
    <div class="p-4 border-b border-gray-100">
        <form action="{{ route('admin.permissions.index') }}" method="GET" class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <!-- Search -->
            ...
            <div class="flex items-center space-x-3">
                ...
                @if(request()->anyFilled(['search', 'group', 'status', 'sort']))
                    <a href="{{ route('admin.permissions.index') }}" class="px-4 py-2 text-sm text-red-600 hover:text-red-700">
                        Clear
                    </a>
                @endif
            </div>
    ...
    <table class="w-full">
        <thead>
            <tr class="bg-gray-50 border-b border-gray-100">
                ...
                <th class="px-6 py-4 text-left">
                    <a href="{{ route('admin.permissions.index', ['sort' => 'name', 'search' => request('search'), 'group' => request('group'), 'status' => request('status')]) }}" class="flex items-center space-x-1 text-xs font-semibold text-gray-500 uppercase tracking-wider hover:text-gray-700">
                ...
                <th class="px-6 py-4 text-left">
                    <a href="{{ route('admin.permissions.index', ['sort' => 'group', 'search' => request('search'), 'group' => request('group'), 'status' => request('status')]) }}" class="flex items-center space-x-1 text-xs font-semibold text-gray-500 uppercase tracking-wider hover:text-gray-700">
                        <span>Group</span>
                ...
                <th class="px-6 py-4 text-center">
                    <a href="{{ route('admin.permissions.index', ['sort' => 'roles', 'search' => request('search'), 'group' => request('group'), 'status' => request('status')]) }}" class="flex items-center justify-center space-x-1 text-xs font-semibold text-gray-500 uppercase tracking-wider hover:text-gray-700">
                        <span>Roles</span>
...
<!-- Floating Add Button -->
<a href="{{ route('admin.permissions.create') }}" class="fixed bottom-6 right-6 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-full p-4 shadow-lg hover:from-blue-600 hover:to-indigo-700 transition-colors z-50" title="Add New Permission">
