...
@section('title', 'Timesheet Details - ' . $user->name)
    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center gap-4">
                <a href="{{ route('admin.timesheets.index', ['year' => $year, 'month' => $month]) }}" class="p-2 bg-gray-100 rounded-lg hover:bg-gray-200">
                ...
                <div>
                    ...
                    <p class="text-gray-500">{{ $user->department?->name ?? 'N/A' }} • {{ $user->email }}</p>
                </div>
            </div>
...
function showRejectModal(entryId) {
    ...
    form.action = '/admin/timesheets/' + entryId + '/approve';
