        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
            ...
            @if($departments->hasPages())
                <div class="px-6 py-4 border-t border-gray-100 pagination-container">
                    <p class="pagination-info">
                        Showing {{ ($departments->currentPage() - 1) * $departments->perPage() + 1 }} to
                        {{ min($departments->currentPage() * $departments->perPage(), $departments->total()) }}
                    ...
                    <div class="pagination">
                        ...
                        @else
                            <a href="{{ $departments->previousPageUrl() }}" class="page-item">
                                <span class="page-link page-btn">&lsaquo;</span>
                            </a>
                        @endif
                        ...
                        @for ($i = 1; $i <= $departments->lastPage(); $i++)
                            ...
                            @else
                                <a href="{{ $departments->url($i) }}" class="page-item">
                                    <span class="page-link">{{ $i }}</span>
                                </a>
                            @endif
                        @endfor
                        ...
                        @if ($departments->hasMorePages())
                            <a href="{{ $departments->nextPageUrl() }}" class="page-item">
            ...
            @else
                <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
                    <p class="text-sm text-gray-500">Showing {{ $departments->count() }} of {{ $departments->total() }} departments</p>
                </div>
            @endif
        </div>
    </div>
