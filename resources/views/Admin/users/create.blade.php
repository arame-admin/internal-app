{{-- User Create Form --}}
{{-- This page provides a form to create a new user with comprehensive validation and error display. --}}
{{-- Includes all user fields organized in logical sections. --}}
...
<div class="bg-gradient-to-br from-blue-50 via-white to-indigo-50 min-h-screen py-8">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}" placeholder="John" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" required>
                        @error('first_name')
                    ...
                    <div>
                        ...
                        <input type="text" id="last_name" name="last_name" value="{{ old('last_name') }}" placeholder="Doe" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" required>
                        @error('last_name')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="john.doe@example.com" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" required>
                        @error('email')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="email" id="personal_email" name="personal_email" value="{{ old('personal_email') }}" placeholder="john.doe@gmail.com" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="job_title" name="job_title" value="{{ old('job_title') }}" placeholder="Software Engineer" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                        @error('job_title')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" id="date_of_joining" name="date_of_joining" value="{{ old('date_of_joining') }}" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                    ...
                    <div>
                        ...
                        <select id="bu_id" name="bu_id" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                            ...
                            @foreach($businessUnits as $businessUnit)
                                <option value="{{ $businessUnit->id }}" {{ old('bu_id') == $businessUnit->id ? 'selected' : '' }}>{{ $businessUnit->name }}</option>
                            @endforeach
                        </select>
                        @error('bu_id')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                    ...
                    <div>
                        ...
                        <input type="email" id="work_email" name="work_email" value="{{ old('work_email') }}" placeholder="john.doe@company.com" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                        @error('work_email')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="work_number" name="work_number" value="{{ old('work_number') }}" placeholder="123-456-7890" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                        @error('work_number')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="dob" name="dob" value="{{ old('dob') }}" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                        @error('dob')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" id="marriage_date" name="marriage_date" value="{{ old('marriage_date') }}" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                        @error('marriage_date')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="nationality" name="nationality" value="{{ old('nationality') }}" placeholder="Indian" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
                        @error('nationality')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="physically_handicapped" value="1" {{ old('physically_handicapped') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
            ...
            <div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="about_me" name="about_me" rows="3" placeholder="Tell us about yourself..." class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">{{ old('about_me') }}</textarea>
                        @error('about_me')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="what_i_love_about_job" name="what_i_love_about_job" rows="3" placeholder="What aspects of your job do you enjoy most..." class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">{{ old('what_i_love_about_job') }}</textarea>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="current_address" name="current_address" rows="3" placeholder="Current residential address..." class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">{{ old('current_address') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="permanent_address" name="permanent_address" rows="3" placeholder="Permanent residential address..." class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">{{ old('permanent_address') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" id="residence_number" name="residence_number" value="{{ old('residence_number') }}" placeholder="Home phone number" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">
