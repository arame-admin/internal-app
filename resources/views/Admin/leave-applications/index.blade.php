...
<div class="p-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6"> 
            <form method="GET" action="{{ route('admin.leave.applications') }}" class="flex flex-col sm:flex-row gap-4 items-end">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <select id="department" name="department" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="flex gap-2"> 
                    ...
                    <a href="{{ route('admin.leave.applications') }}" class="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium">
                        Clear
                    </a>
                </div>
            </form>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right space-x-2">
                                    @if($application->status === 'pending')
                                        <form action="{{ route('admin.leave.applications.approve', $application->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('PUT')
