...
{{-- This page provides a form to edit an existing business unit with validation and error display. --}}
    ...
    <div class="max-w-4xl mx-auto px-4">
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <li><span class="text-gray-400">/</span></li>
                <li class="text-gray-900 font-medium">Edit Business Unit</li>
            </ol>
        </nav>

        <form action="{{ route('admin.business-units.update', Crypt::encrypt($businessUnit->id)) }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $businessUnit->name) }}" placeholder="e.g., Technology Division" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" required>
                @error('name')
            ...
            <div>
                ...
                <input type="text" id="code" name="code" value="{{ old('code', $businessUnit->code) }}" placeholder="e.g., TECH" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" required>
                @error('code')
                    <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                @enderror
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3" placeholder="Optional description of the business unit..." class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">{{ $businessUnit->description }}</textarea>
