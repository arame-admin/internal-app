        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="client_id" name="client_id" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all bg-white">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    deptSelect.addEventListener('change', function() {
        ...
        tasks = deptTasks.slice(); // Copy array
        updateTasksDisplay();
    });
