...
@section('title', 'Change Client Status')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-100">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <p class="text-sm text-gray-500 mb-1">Projects Assigned</p>
                    <p class="text-lg font-semibold text-gray-800">5 projects</p>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('clients.updateStatus', $id) }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <label class="relative cursor-pointer group">
                        ...
                        <div class="p-4 rounded-xl border-2 border-gray-200 peer-checked:border-green-500 peer-checked:bg-green-50 transition-all group-hover:border-green-300">
                            ...
                            <p class="text-sm text-gray-500 mt-1">Client will be active and can be assigned to projects</p>
                        </div>
                    </label>
                    ...
                    <label class="relative cursor-pointer group">
                        ...
                        <div class="p-4 rounded-xl border-2 border-gray-200 peer-checked:border-red-500 peer-checked:bg-red-50 transition-all group-hover:border-red-300">
                            ...
                            <p class="text-sm text-gray-500 mt-1">Client will be inactive and cannot be assigned to new projects</p>
                        </div>
                    </label>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="reason" name="reason" rows="2" placeholder="Enter reason for status change..." class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all resize-none"></textarea>
            </div>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-yellow-700 mt-1">If you set this client to inactive, they will not be able to access new projects until reactivated.</p>
                    </div>
                </div>
            </div>
