...
/**
 * MandatoryHoliday Model
 *
 * Represents a mandatory holiday for a company holiday configuration.
 *
 ...
 */
class MandatoryHoliday extends Model
{
    use HasFactory;

    protected $table = 'mandatory_holidays';
    ...
    /**
     * Get the company holiday that owns this mandatory holiday.
     */
